...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        find_node = SelectorNode("Find Ball")
        find_node.add_children(find_ball_node, move_to_ball_node)
        chase_node.add_children(find_player_node, move_to_player_node)
        wander_chase_node = SelectorNode("WanderChase")
        wander_chase_node.add_children(chase_node, wander_node, find_node)
